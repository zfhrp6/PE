...
straight = ("23456", "34567", "45678", "56789",
            "6789T", "789JT", "89JTQ", "9JKQT", "AJKQT")
...
point_dic = {"A": 14, "K": 13, "Q": 12, "J": 11, "T": 10, "9": 9,
...
def main():
    ...
    for trn in turns:
        ...
        ply1 = Tefuda(pl1)
        ply2 = Tefuda(pl2)
        if win_lose((ply1.rank(), next(ply1)), (ply2.rank(), next(ply2))):
            answer += 1
    return answer
